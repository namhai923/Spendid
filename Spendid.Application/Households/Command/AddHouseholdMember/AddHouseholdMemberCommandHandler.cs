...
internal sealed class RemoveHouseholdMemberCommandHandler(IHouseholdRepository householdRepository, IUserRepository userRepository, IUnitOfWork unitOfWork) : ICommandHandler<AddHouseholdMemberCommand>
{
